...
public class SlotMachineGUI {
    ...
    class TrollfaceHandler implements ActionListener {
        public void actionPerformed(ActionEvent e) {
            if (cbTrollface.isSelected() == true && images.get(images.size() - 1) != createImageIcon("imgs/Trollface.png", "Trollface")) {
                images.add(createImageIcon("imgs/Trollface.png", "Trollface")); // adds a bonus image to the images ArrayList.
                lblStatus.setText("Trollface mode ENABLED! Trolololololol!");
            }
            if (cbTrollface.isSelected() == false && images.get(images.size() - 1) != createImageIcon("imgs/Trollface.png", "Trollface")) {
    ...
    public void loadImages() {
        images.add(createImageIcon("imgs/Banana.png", "Banana"));
        images.add(createImageIcon("imgs/Bar.png", "Bar"));
        images.add(createImageIcon("imgs/Bell.png", "Bell"));
        images.add(createImageIcon("imgs/Cherry.png", "Cherry"));
        images.add(createImageIcon("imgs/Clover.png", "Clover"));
        images.add(createImageIcon("imgs/Diamond.png", "Diamond"));
        images.add(createImageIcon("imgs/Plum.png", "Plum"));
        images.add(createImageIcon("imgs/Seven.png", "Seven"));
        images.add(createImageIcon("imgs/Watermelon.png", "Watermelon"));
    }
